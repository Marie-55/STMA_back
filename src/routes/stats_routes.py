...
@stat_routes.route('/stats/<user_id>', methods=['GET'])
...
@stat_routes.route('/stats/<user_id>/task', methods=['POST'])
...
@stat_routes.route('/stats/<user_id>/productivity', methods=['GET'])
...
@stat_routes.route('/stats/<user_id>/duration', methods=['POST'])
