...
@stats_routes.route('/stats/<user_id>', methods=['GET'])
...
@stats_routes.route('/stats/<user_id>/task', methods=['POST'])
...
@stats_routes.route('/stats/<user_id>/productivity', methods=['GET'])
...
@stats_routes.route('/stats/<user_id>/duration', methods=['POST'])
